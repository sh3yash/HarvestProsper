...
const HomePage = () => {
  ...
  return (
    <div className="homepage">
      {/* Hero Section without background effects */}
      <div className="hero-section">
        <Spline scene="https://prod.spline.design/uCIeEEJ-kHScf1CP/scene.splinecode" />
      ...
      {/* Conditional rendering of the Advisor Chat component */}
